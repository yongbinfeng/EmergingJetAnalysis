...
namespace emjet
{
  ...
  public:
    ...
    void Init() {
      ...
      met_pt_JetResUp                         = DEFAULTVALUE;
      met_pt_JetResDown                       = DEFAULTVALUE;
      met_pt_JetEnUp                          = DEFAULTVALUE;
      met_pt_JetEnDown                        = DEFAULTVALUE;
      met_pt_UnclEnUp                         = DEFAULTVALUE;
      met_pt_UnclEnDown                       = DEFAULTVALUE;
      metT1_pt                                = DEFAULTVALUE;
      metT1_phi                               = DEFAULTVALUE;
      metT1_sumEt                             = DEFAULTVALUE;
      metT1_pt_JetResUp                       = DEFAULTVALUE;
      metT1_pt_JetResDown                     = DEFAULTVALUE;
      metT1_pt_JetEnUp                        = DEFAULTVALUE;
      metT1_pt_JetEnDown                      = DEFAULTVALUE;
      metT1_pt_UnclEnUp                       = DEFAULTVALUE;
      metT1_pt_UnclEnDown                     = DEFAULTVALUE;
      ...
      metFilter_HBHENoise                     = DEFAULTVALUE;
      metFilter_HBHENoiseIso                  = DEFAULTVALUE;
      metFilter_EcalDeadCellTriggerPrimitive  = DEFAULTVALUE;
...
WriteEventToOutput(const Event& event, emjet::OutputTree* otree)
{
  ...
  // Event-level variables, e.g. int, float, etc.
  {
    ...
    otree->met_pt_JetResUp                         = event.met_pt_JetResUp                        ;
    otree->met_pt_JetResDown                       = event.met_pt_JetResDown                      ;
    otree->met_pt_JetEnUp                          = event.met_pt_JetEnUp                         ;
    otree->met_pt_JetEnDown                        = event.met_pt_JetEnDown                       ;
    otree->met_pt_UnclEnUp                         = event.met_pt_UnclEnUp                        ;
    otree->met_pt_UnclEnDown                       = event.met_pt_UnclEnDown                      ;
    otree->metT1_pt                                = event.metT1_pt                               ;
    otree->metT1_phi                               = event.metT1_phi                              ;
    otree->metT1_sumEt                             = event.metT1_sumEt                            ;
    otree->metT1_pt_JetResUp                       = event.metT1_pt_JetResUp                      ;
    otree->metT1_pt_JetResDown                     = event.metT1_pt_JetResDown                    ;
    otree->metT1_pt_JetEnUp                        = event.metT1_pt_JetEnUp                       ;
    otree->metT1_pt_JetEnDown                      = event.metT1_pt_JetEnDown                     ;
    otree->metT1_pt_UnclEnUp                       = event.metT1_pt_UnclEnUp                      ;
    otree->metT1_pt_UnclEnDown                     = event.metT1_pt_UnclEnDown                    ;
    ...
    otree->metFilter_HBHENoise                     = event.metFilter_HBHENoise                    ;
    otree->metFilter_HBHENoiseIso                  = event.metFilter_HBHENoiseIso                 ;
    otree->metFilter_EcalDeadCellTriggerPrimitive  = event.metFilter_EcalDeadCellTriggerPrimitive ;
