...
jobname = 'HLT-Analysis-20171208'        # Jobname
...
#     # dataset( "Dummy" , Dummy , MC , 1 , 10000 , splitting='FileBased' , priority=99 , label='signal' ) ,
    ...
    dataset( "HLT_JetHT_G1_b"    , JetHT_G1    , DATA , 5  , 10000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    dataset( "HLT_JetHT_H1_b"    , JetHT_H1    , DATA , 5  , 10000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  , # No jobs generated with json file
    dataset( "HLT_JetHT_H2_b"    , JetHT_H2    , DATA , 5  , 10000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    dataset( "HLT_JetHT_H3_b"    , JetHT_H3    , DATA , 5  , 10000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
]
