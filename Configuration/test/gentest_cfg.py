...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        # Generator test events
        # 'file:/home/yhshin/EmJetMCProd/CMSSW_7_1_20_patch3/src/EmJetGenSim/output/decayModeTest0.root'
        # 'file:/home/yhshin/EmJetMCProd/CMSSW_7_1_20_patch3/src/EmJetGenSim/output/decayModeTest91.root'
        'file:/home/yhshin/EmJetMCProd/CMSSW_7_1_20_patch3/src/EmJetGenSim/output/decayModeTest102.root'
    ),
)
...
if testgp:
    ...
    # process.out.outputCommands.extend(cms.untracked.vstring('keep *_genParticleAnalyzer_*_*',))
