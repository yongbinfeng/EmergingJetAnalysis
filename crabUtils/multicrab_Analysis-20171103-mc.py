...
jobname = 'Analysis-20171103'        # Jobname
psetname = 'Configuration/test/test_cfg.py'      # Path to pset
postfix = 'v1b'                # Postfix to job, increment for each major version
dryrun = 0
...
#     # dataset( "Dummy" , Dummy , MC , 1 , 10000 , splitting='FileBased' , priority=99 , label='signal' ) ,
    ...
    # JetHT data
    # dataset( "JetHT_B1"    , JetHT_B1    , DATA , 20  , 100000000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "JetHT_B3"    , JetHT_B3    , DATA , 20  , 100000000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "JetHT_C1"    , JetHT_C1    , DATA , 20  , 100000000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "JetHT_D1"    , JetHT_D1    , DATA , 20  , 100000000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "JetHT_E1"    , JetHT_E1    , DATA , 20  , 100000000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "JetHT_F1"    , JetHT_F1    , DATA , 20  , 100000000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
...
template = dataset( "ALIAS"  , "/FULL/PATH-TO/DATSET"  , MC , 1 , 10000 , splitting='FileBased' , priority=99 , inputDBS='phys03' , label='signal' , doHLT=0 )
dataset_list = load_datasets('crabUtils/dataset_lists/list_RunIISummer16DR80Premix_private-AODSIM-v2017-09-11re.txt', template)
print 'dataset_list'
