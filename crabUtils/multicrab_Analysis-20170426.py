...
#     dataset( "mass_pi_d_10_tau_pi_d_300"   , mass_pi_d_10_tau_pi_d_300   , MC , 1 , 10000 , splitting='FileBased' , priority=99 , inputDBS='phys03' , label='signal' , doHLT=0 ) ,
    # dataset( "QCD80_HT50to100"             , QCD_HT50to100    , MC , 10 , 10000 , splitting='FileBased' , priority=10 , label='signal' ) ,
    # dataset( "QCD80_HT100to200"            , QCD_HT100to200   , MC , 10 , 10000 , splitting='FileBased' , priority=10 , label='signal' ) ,
    # dataset( "QCD80_HT200to300"            , QCD_HT200to300   , MC , 10 , 10000 , splitting='FileBased' , priority=10 , label='signal' ) ,
    # dataset( "QCD80_HT300to500"            , QCD_HT300to500   , MC , 10 , 10000 , splitting='FileBased' , priority=10 , label='signal' ) ,
    # dataset( "QCD80_HT500to700"            , QCD_HT500to700   , MC , 10 , 10000 , splitting='FileBased' , priority=10 , label='signal' ) ,
    # dataset( "QCD80_HT700to1000"           , QCD_HT700to1000  , MC , 10 , 10000 , splitting='FileBased' , priority=80 , label='signal' ) ,
    # dataset( "QCD80_HT1000to1500"          , QCD_HT1000to1500 , MC , 10 , 10000 , splitting='FileBased' , priority=90 , label='signal' ) ,
    # dataset( "QCD80_HT1500to2000"          , QCD_HT1500to2000 , MC , 10 , 10000 , splitting='FileBased' , priority=80 , label='signal' ) ,
    # dataset( "QCD80_HT2000toInf"           , QCD_HT2000toInf  , MC , 5  , 10000 , splitting='FileBased' , priority=70 , label='signal' ) ,
    dataset( "WJet80"                      , WJet             , MC , 10 , 10000 , splitting='FileBased' , priority=70 , label='wjet' )   ,
]
