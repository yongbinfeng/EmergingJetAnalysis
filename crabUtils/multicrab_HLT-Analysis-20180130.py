...
jobname = 'HLT-Analysis-20180130'        # Jobname
...
#     # dataset( "Dummy" , Dummy , MC , 1 , 10000 , splitting='FileBased' , priority=99 , label='signal' ) ,
    ...
    dataset( "HLT_QCD_HT50to100"     , QCD_HT50to100     , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    dataset( "HLT_QCD_HT100to200"    , QCD_HT100to200    , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    dataset( "HLT_QCD_HT200to300"    , QCD_HT200to300    , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    dataset( "HLT_QCD_HT300to500"    , QCD_HT300to500    , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_QCD_HT500to700"    , QCD_HT500to700    , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_QCD_HT700to1000"   , QCD_HT700to1000   , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_QCD_HT1000to1500"  , QCD_HT1000to1500  , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_QCD_HT1500to2000"  , QCD_HT1500to2000  , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_QCD_HT1500to2000x" , QCD_HT1500to2000x , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_QCD_HT2000toInf"   , QCD_HT2000toInf   , MC , 5  , 10000 , splitting='FileBased' , priority=199 , label='signal' , doHLT=1 )  ,
    ...
    # dataset( "HLT_SingleMuon_G1"    , SingleMuon_G1    , DATA , 5   , 300000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_SingleMuon_H1"    , SingleMuon_H1    , DATA , 5   , 300000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  , # No jobs generated with json file
    # dataset( "HLT_SingleMuon_H2"    , SingleMuon_H2    , DATA , 5   , 300000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
    # dataset( "HLT_SingleMuon_H3"    , SingleMuon_H3    , DATA , 5   , 300000 , splitting='LumiBased' , priority=199 , label='signal' , doHLT=1 )  ,
]
