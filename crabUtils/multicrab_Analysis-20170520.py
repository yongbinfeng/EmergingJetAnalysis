...
#     dataset( "mass_pi_d_10_tau_pi_d_300"   , mass_pi_d_10_tau_pi_d_300   , MC , 1 , 10000 , splitting='FileBased' , priority=99 , inputDBS='phys03' , label='signal' , doHLT=0 ) ,
    ...
    dataset( "QCD_HT500to700"   , QCD_HT500to700   , MC , 10 , 10000 , splitting='FileBased' , priority=10 , label='signal' )  ,
    dataset( "QCD_HT700to1000"  , QCD_HT700to1000  , MC , 10 , 10000 , splitting='FileBased' , priority=80 , label='signal' )  ,
    dataset( "QCD_HT1000to1500" , QCD_HT1000to1500 , MC , 10 , 10000 , splitting='FileBased' , priority=90 , label='signal' )  ,
    dataset( "QCD_HT1500to2000" , QCD_HT1500to2000 , MC , 10 , 10000 , splitting='FileBased' , priority=80 , label='signal' )  ,
    dataset( "QCD_HT2000toInf"  , QCD_HT2000toInf  , MC , 5  , 10000 , splitting='FileBased' , priority=70 , label='signal' )  ,
    dataset( "WJet"             , WJet             , MC , 10 , 10000 , splitting='FileBased' , priority=70 , label='wjet' )    ,
]
